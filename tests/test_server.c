/*
 * test_server.c — Unit tests for the HTTP server routing and request handling.
 *
 * Tests route registration, handler dispatch, MHD request wrapping,
 * CORS header generation, security headers, and request body size limits.
 */
