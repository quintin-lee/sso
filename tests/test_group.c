/*
 * test_group.c — Unit tests for the group management module.
 *
 * Tests group CRUD, hierarchical nesting (parent_group_id),
 * member add/remove, and group-level policy inheritance.
 */
