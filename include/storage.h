...
typedef sso_error_t (*storage_user_list_fn)(storage_backend_t* self, const char* q, int status, int offset, int limit,
											sso_id_t* ids, size_t* count, size_t* total_count);

/* SMS */
typedef sso_error_t (*storage_save_sms_code_fn)(storage_backend_t* self, const char* phone, const char* code,
...
typedef sso_error_t (*storage_role_list_fn)(storage_backend_t* self, const char* q, int status, int offset, int limit,
											sso_id_t* ids, size_t* count, size_t* total_count);
...
typedef sso_error_t (*storage_group_list_fn)(storage_backend_t* self, const char* q, int status, int offset, int limit,
											 sso_id_t* ids, size_t* count, size_t* total_count);
...
typedef sso_error_t (*storage_policy_list_fn)(storage_backend_t* self, const char* q, int status, int offset, int limit,
											  sso_id_t* ids, size_t* count, size_t* total_count);
...
typedef sso_error_t (*storage_get_user_roles_fn)(storage_backend_t* self, sso_id_t user_id, sso_id_t* role_ids,
												 size_t* count, size_t max);
typedef sso_error_t (*storage_get_role_users_fn)(storage_backend_t* self, sso_id_t role_id, sso_id_t* user_ids,
												 size_t* count, size_t max);
...
typedef sso_error_t (*storage_get_user_groups_fn)(storage_backend_t* self, sso_id_t user_id, sso_id_t* group_ids,
												  size_t* count, size_t max);
typedef sso_error_t (*storage_get_group_users_fn)(storage_backend_t* self, sso_id_t group_id, sso_id_t* user_ids,
												  size_t* count, size_t max);
...
typedef sso_error_t (*storage_get_policy_targets_fn)(storage_backend_t* self, sso_id_t policy_id,
													 policy_target_type_t target_type, sso_id_t* target_ids,
													 size_t* count, size_t max);
typedef sso_error_t (*storage_get_target_policies_fn)(storage_backend_t* self, policy_target_type_t target_type,
													  sso_id_t target_id, sso_id_t* policy_ids, size_t* count,
													  size_t max);
...
typedef sso_error_t (*storage_get_user_roles_with_ancestors_fn)(storage_backend_t* self, sso_id_t user_id,
...
typedef sso_error_t (*storage_audit_log_list_fn)(storage_backend_t* self, sso_id_t user_id, int offset, int limit,
...
typedef sso_error_t (*storage_oauth_client_get_fn)(storage_backend_t* self, const char* client_id,
...
typedef sso_error_t (*storage_oauth_client_list_fn)(storage_backend_t* self, int offset, int limit,
