...
/* POST /api/v1/check */
sso_error_t handle_check_permission(sso_context_t *ctx, const http_request_t *req,
...
sso_error_t handle_check_functional(sso_context_t *ctx, const http_request_t *req,
                                            http_response_t *resp) {
    if (!req->body) {
        sso_response_error(resp, 400, "Request body required");
        return SSO_OK;
...
sso_error_t handle_check_api(sso_context_t *ctx, const http_request_t *req,
                                     http_response_t *resp) {
    if (!req->body) {
        sso_response_error(resp, 400, "Request body required");
        return SSO_OK;
...
sso_error_t handle_check_data(sso_context_t *ctx, const http_request_t *req,
                                      http_response_t *resp) {
    if (!req->body) {
        sso_response_error(resp, 400, "Request body required");
        return SSO_OK;
...
sso_error_t handle_check_rbac(sso_context_t *ctx, const http_request_t *req,
                                      http_response_t *resp) {
    if (!req->body) {
        sso_response_error(resp, 400, "Request body required");
        return SSO_OK;
...
sso_error_t handle_check_location(sso_context_t *ctx, const http_request_t *req,
                                      http_response_t *resp) {
    if (!req->body) {
        sso_response_error(resp, 400, "Request body required");
        return SSO_OK;
...
sso_error_t handle_check_lbac(sso_context_t *ctx, const http_request_t *req,
                                      http_response_t *resp) {
    if (!req->body) {
        sso_response_error(resp, 400, "Request body required");
        return SSO_OK;
...
sso_error_t handle_check_abac(sso_context_t *ctx, const http_request_t *req,
                                      http_response_t *resp) {
    if (!req->body) {
        sso_response_error(resp, 400, "Request body required");
        return SSO_OK;
